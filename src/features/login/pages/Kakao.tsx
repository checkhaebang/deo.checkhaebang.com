...
export default function Kakao(): ReactElement {
  return (
    <div style={page_style()}>
      ...
      <div
        style={카카오_계정으로_시작하기_버튼_style()}
        onClick={() =>
          (window.location.href = `https://api.checkhaebang.com/oauth/kakao`)
        }
      >
        <p style={카카오_계정으로_시작하기_버튼_글자_style()}>
          카카오 계정으로 시작하기
        </p>
      </div>
    </div>
...
const 카카오_계정으로_시작하기_버튼_style = (): CSSProperties => ({
  display: "flex",
...
const 카카오_계정으로_시작하기_버튼_글자_style = (): CSSProperties => ({
  height: 22,
  fontSize: 16,
  fontWeight: "bold",
  fontStretch: "normal",
