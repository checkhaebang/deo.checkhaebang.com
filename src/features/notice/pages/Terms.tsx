...
export default function Terms(): ReactElement {
  return (
    <div>
      <article style={{ height: 720, overflow: "auto" }}>
        <header>
          <h1>체크해방 개인정보처리보호 방침</h1>
        </header>
        <div>
          <p>
            <em>
              (&#x27;https://checkhaebang.com&#x27;이하 &#x27;체크해방&#x27;)
            </em>
          ...
          <p>
            <em>(&#x27;체크해방&#x27;)</em> 은(는) 회사는 개인정보처리방침을
            개정하는 경우 웹사이트 공지사항(또는 개별공지)을 통하여 공지할
            것입니다.
          </p>
          <p>
            ○ 본 방침은부터 <em>2020</em>년 <em>1</em>월 <em>1</em>일부터
            시행됩니다.
          </p>
          <p>
          ...
          <ul>
            <li>
              <strong>1. 개인정보 파일명 : 개인정보파일</strong>
            </li>
          </ul>
          <ul>
            <li>
              개인정보 항목 : 이메일, 로그인, 접속 로그, 쿠키, 접속 IP 정보,
              결제기록
            </li>
          </ul>
          <ul>
          ...
          <p>
            ② (&#x27;https://checkhaebang.com&#x27;)은(는) 다음과 같이
          ...
          <ul>
            <li>개인정보를 제공받는 자 : 체크해방</li>
          </ul>
          <ul>
            <li>
              제공받는 자의 개인정보 이용목적 : 이메일, 로그인, 접속 로그, 쿠키,
              접속 IP 정보, 결제기록
            </li>
          </ul>
          <ul>
          ...
          <ul>
            <li>위탁받는 자 (수탁자) : landlords</li>
          </ul>
          <ul>
            <li>
              위탁하는 업무의 내용 : 구매 및 요금 결제, 물품배송 또는 청구서 등
              발송, 본인인증(금융거래, 금융서비스), 요금추심, 회원제 서비스
              이용에 따른 본인확인, 불만처리 등 민원처리, 고지사항 전달, 신규
              서비스(제품) 개발 및 맞춤 서비스 제공, 이벤트 및 광고성 정보 제공
              및 참여기회 제공, 영상정보처리기기 운영
            </li>
          </ul>
          <ul>
            <li>위탁기간 : 1년</li>
          ...
          <p>
            ② (&#x27;https://checkhaebang.com&#x27;이하
            &#x27;체크해방&#x27;)은(는) 위탁계약 체결시 개인정보 보호법 제25조에
          ...
          <p>
            ① 정보주체는 landlords에 대해 언제든지 개인정보
            열람,정정,삭제,처리정지 요구 등의 권리를 행사할 수 있습니다.
          </p>
          <p>
            ② 제1항에 따른 권리 행사는landlords에 대해 개인정보 보호법 시행령
            제41조제1항에 따라 서면, 전자우편, 모사전송(FAX) 등을 통하여 하실 수
            있으며 landlords은(는) 이에 대해 지체 없이 조치하겠습니다.
          </p>
          <p>
          ...
          <p>
            ⑥ landlords은(는) 정보주체 권리에 따른 열람의 요구, 정정·삭제의
          ...
          <ul>
            <li>
              필수항목 : 이메일, 로그인, 접속 로그, 쿠키, 접속 IP 정보, 결제기록
            </li>
          </ul>
          <ul>
            <li>선택항목 :</li>
          ...
          <ul>
            <li>
              ...
              않습니다.파기기한이용자의 개인정보는 개인정보의 보유기간이 경과된
          ...
          <p>
            ① landlords 은 개별적인 맞춤서비스를 제공하기 위해 이용정보를
          ...
          <p>
            ① landlords(‘https://checkhaebang.com’이하 ‘체크해방) 은(는)
          ...
          <ul>
            <li>연락처 : nexters.landlords@gmail.com,</li>
          </ul>
          ...
          <p>
            ② 정보주체께서는 landlords(‘https://checkhaebang.com’이하 ‘체크해방)
          ...
          <p>
            ...
            <strong>
              은(는) 개인정보보호법 제29조에 따라 다음과 같이 안전성 확보에
